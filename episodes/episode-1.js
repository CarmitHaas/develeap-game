...
const EPISODE_1 = {
  ...
  endings: {
    ...
    true_ending: {
      headline: "היום הזה היה יום מטורף. וגם אחד הרגעים שעיצבו מחדש את תפישת המנטורינג שלי.",
      sub:
        ...
        "מה שלמדתי בשעה האחרונה:\n" +
        "• כשמישהו צעיר טועה, התפקיד שלך הוא לעמוד מאחוריו, לא לפניו.\n" +
        "• pair-review בלחץ זה לא בזבוז של זמן. זה קיים מסיבה טובה.\n" +
    ...
    colossal_ending: {
      ...
      sub:
        ...
        "אין נפגעים. הפאנלים הסולאריים החזיקו. ענבר התפטרה. אני התפטרתי. Aviv פתח שלושה Notion docs חדשים. המיקרוגל סוף סוף נכבה (אין חשמל).\n\n" +
